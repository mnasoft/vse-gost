...
(defun directory-wildcard (dirname)
  (make-pathname 
    ...
    :type #-clisp 
    :wild #+clisp 
    nil :defaults (pathname-as-directory dirname)))
...
(defun list-directory (dirname)
  ...
  (let 
    ((wildcard (directory-wildcard dirname)))
...
(defun file-exists-p (pathname)
  ...
  (or 
    ...
    (ignore-errors
      (let
	((directory-form (pathname-as-directory pathname)))
...
(defun walk-directory (dirname fn &key directories (test (constantly t)))
  (labels 
	...
	(cond
	  (
	    (directory-pathname-p name)
	    (when (and directories (funcall test name)) (funcall fn name))
